            ...
            <TabsContent value="signin" className="mt-6">
              <form onSubmit={onSignIn} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full gradient-thread text-[color:var(--accent-foreground)] border-0 hover:opacity-90"
                >
            ...
            <form onSubmit={onForgot} className="space-y-4 mt-8">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="flex-1 gradient-thread text-[color:var(--accent-foreground)] border-0"
                >
